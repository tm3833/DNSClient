...
if __name__ == '__main__':
    ...
    local_external_DNS_output(question_type) #uncommented
    ...
    local_dns_result = query_local_dns_server('nyu.edu.',question_type)
    print("comparision result:", compare_result)
    print("local dns results for nyu.edu:", local_dns_result)
